...
3. `contact_sheet_dry_media_wavy_line_v4.png` controls colored-pencil scumbling, wax-crayon marks, paper tooth, and continuously wandering strokes;
4. `contact_sheet_thin_stroke_anatomy_v2.png` controls the black dry breaks, open joins, overshoots, retracing, and pressure changes in exactly two arms, two legs, and every facial mark.
...
- source palette;
- thin-to-medium hesitant black line structure with occasional retracing, open joins, and overshoot; for `flavor-monster`, apply this primarily to the face, two arms, two legs, and sparse partial marks rather than a complete body contour;
